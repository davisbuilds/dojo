...
5. **Apply YAGNI Rigorously**:
   ...
   - Never flag `docs/design/*.md`, `docs/specs/*.md`, or `docs/plans/*.md` for removal — these are pre-execution pipeline artifacts (brainstorm direction, spec contract, implementation plan) and serve as living documents during execution
