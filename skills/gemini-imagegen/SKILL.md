...
description: Generate and edit images using the Gemini API (Nano Banana Pro). Use when creating images from text prompts, editing existing images, doing multi-turn iterative refinement, or generating images with specific aspect ratios and resolutions via Google's Gemini image models.
---
...
**CRITICAL:** The Gemini API returns images in JPEG format by default. Always use `.jpg` extension to avoid media type mismatches.
