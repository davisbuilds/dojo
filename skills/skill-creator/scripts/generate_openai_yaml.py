#!/usr/bin/env python3
"""
OpenAI metadata generator (optional platform add-on).

Creates agents/openai.yaml for a skill directory.
...
def main():
    parser = argparse.ArgumentParser(
        description="Create optional agents/openai.yaml for a skill directory.",
    )
